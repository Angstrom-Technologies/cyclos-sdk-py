...
class AccountsClient:
    """List accounts, retrieve statuses and balances, and fetch history."""
    ...
    def list(
        ...
        *,
        ...
        """List accounts for an owner/member."""
    ...
    def get(self, member_id: str, account_type: str) -> Account:
        """Retrieve the account status for a specific account type."""
        response = self._client._transport.get(f"/{member_id}/accounts/{account_type}")
    ...
    def get_balance(
        ...
        *,
        ...
        """Return a strongly typed balance for the given member and account type."""
        account = self.get(member_id, account_type)
    ...
    def history(
        ...
        *,
        ...
        """Fetch account history (balance transfers)."""
        params: dict[str, Any] = {
            "page": page,
            "pageSize": page_size,
        }
